...
| LVS | **match** (1 mismatches, engine `klayout`) | [`layout/logic_tile.lvs.json`](layout/logic_tile.lvs.json) | commit `8a42d84 2026-09-09 17:12:56 -0700` |
| ERC (supply connectivity + antenna) | **0 findings**, 0 antenna `violate` across 232 gates | [`layout/logic_tile.erc.json`](layout/logic_tile.erc.json) | commit `unknown (no commit found)` |
...
- **Source**: [`layout/logic_tile.erc.json`](layout/logic_tile.erc.json) (layout GDS hash `sha256:38498092805ec6a6f23cf9e13f57a055f765412595b422b66cf3a24ae6722a7f`, produced by klt `0.5.0+g2b7caa9939af`)
...
- **Committed at**: `unknown (no commit found)`
